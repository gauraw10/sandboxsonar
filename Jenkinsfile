...
sh "${sonar} -Dsonar.projectKey=ct.sandbox.demo-jenkins -Dsonar.projectName=CT-SANDBOX-DEMO-JENKINS -Dsonar.sources=. -Dsonar.java.binaries=. -Dsonar.login=cbc22c4b2b14561d286bc646f26e1ea086660a26 -Dsonar.host.url=http://192.168.0.6:9000"
}
